...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        meals.forEach(meal -> {
            ...
            if (TimeUtil.isBetweenHalfOpen(localDateTime.toLocalTime(), startTime, endTime)) {
                mealsWithExcess.add(new UserMealWithExcess(meal, caloriesByDay.get(localDateTime.toLocalDate()) > caloriesPerDay));
            }
        });
    ...
    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        Map<LocalDate, Integer> caloriesByDay = meals
                .stream()
        ...
        return meals
                ...
                .map(meal -> new UserMealWithExcess(meal, caloriesByDay.get(meal.getDateTime().toLocalDate()) > caloriesPerDay))
